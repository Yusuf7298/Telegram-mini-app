...
const envSchema = z.object({
  ...
  PGBOUNCER_DISABLED: z.enum(["0", "1"]).optional(),
  PG_POOL_MAX: z.string().optional(),
  PG_IDLE_TIMEOUT_MS: z.string().optional(),
  PG_CONNECTION_TIMEOUT_MS: z.string().optional(),
  PRISMA_TX_MAX_RETRIES: z.string().optional(),
  PRISMA_TX_MAX_WAIT_MS: z.string().optional(),
  PRISMA_TX_TIMEOUT_MS: z.string().optional(),
  PRISMA_RETRY_DELAYS_MS: z.string().optional(),
