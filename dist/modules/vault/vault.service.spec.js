...
describe("claimVault", () => {
    ...
    it("claims vault reward successfully", async () => {
        ...
        const reward = await (0, vault_service_1.claimVault)("user-1", "vault-1");
    ...
    it("prevents double claim", async () => {
        ...
        mockPrisma.$transaction.mockImplementation(async (cb) => cb(tx));
        await expect((0, vault_service_1.claimVault)("user-1", "vault-1")).rejects.toThrow("Already claimed");
